...
class Point2RBoxV2ResNet(BaseModule):
    """ResNet backbone.
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(Point2RBoxV2ResNet, self).__init__(init_cfg)
        ...
        for i, num_blocks in enumerate(self.stage_blocks):
            ...
            if plugins is not None:
                ...
                stage_plugins = None
            planes = min(base_channels * 2**i, 512)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(Point2RBoxV2ResNet, self).train(mode)
        self._freeze_stages()
